...
const DEFAULT_PRODUCTS = [
  { id: 1, name: "Rau cải xanh", category: "Rau", price: 15000, oldPrice: 18000, stock: 50, cert: "VietGAP", code: "ECO001", rating: 4.8, image: "OIP.webp", desc: "Rau cải xanh sạch đạt chuẩn VietGAP, thu hoạch trong ngày, không tồn dư thuốc bảo vệ thực vật." },
  { id: 2, name: "Cam sành Hà Giang", category: "Trái cây", price: 35000, oldPrice: 42000, stock: 30, cert: "Organic", code: "ECO002", rating: 4.9, image: "OIP (1).webp", desc: "Cam sành hữu cơ trồng trên vùng núi đá, mọng nước, giàu vitamin C." },
  { id: 3, name: "Trứng gà ta", category: "Thực phẩm", price: 45000, oldPrice: 50000, stock: 100, cert: "HACCP", code: "ECO003", rating: 5, image: "R.jpg", desc: "Trứng gà thả vườn, giàu dinh dưỡng, kiểm soát an toàn theo tiêu chuẩn HACCP." },
  { id: 4, name: "Táo hữu cơ", category: "Trái cây", price: 89000, oldPrice: 98000, stock: 35, cert: "Organic", code: "ECO004", rating: 4.7, image: "2017-03-20-09-31-57-1152x766.jpg", desc: "Táo hữu cơ nhập khẩu, giòn ngọt, giàu chất xơ và vitamin." },
  { id: 5, name: "Cà chua bi", category: "Rau", price: 28000, oldPrice: 32000, stock: 45, cert: "VietGAP", code: "ECO005", rating: 4.6, image: "OIP (2).webp", desc: "Cà chua bi tươi, vị ngọt tự nhiên, thu hoạch trong ngày." },
  { id: 6, name: "Thịt heo sạch", category: "Thịt", price: 120000, oldPrice: 135000, stock: 20, cert: "HACCP", code: "ECO006", rating: 4.8, image: "OIP (3).webp", desc: "Thịt heo nuôi theo quy trình an toàn sinh học, kiểm soát HACCP toàn chuỗi." },
  { id: 7, name: "Xà lách hữu cơ", category: "Rau", price: 22000, oldPrice: 25000, stock: 40, cert: "Organic", code: "ECO007", rating: 4.5, image: "xa-lach-lolo-xanh_1ecdb9c6a85c4c58803f3ee6fe568f01_1024x1024.webp", desc: "Xà lách trồng thủy canh trong nhà màng, lá xanh giòn, thích hợp ăn sống." },
  { id: 8, name: "Tôm sú tươi", category: "Hải sản", price: 220000, oldPrice: 245000, stock: 18, cert: "Organic", code: "ECO008", rating: 4.9, image: "OIP (4).webp", desc: "Tôm sú nuôi quảng canh hữu cơ tại Cà Mau, tươi sống trong ngày." },
];
